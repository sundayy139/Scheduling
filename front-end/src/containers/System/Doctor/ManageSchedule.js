...
class ManageSchedule extends Component {
    ...
    handleSaveSchedule = async () => {
        ...
        let formattedDate = moment(new Date(currentDate).toLocaleDateString()).format('YYYY-MM-DD');
                        ...
                        <div className='row mt-5'>
                            <div className='col-12'>
                                ...
                                <div className='border'>
                                    {
                                        rangeTime && rangeTime.length > 0 && rangeTime.map((item, i) => {
                                            return (
                                                <button
                                                    className={item.isSelected === true ? 'btn btn-outline-primary active mx-3 my-3' : 'btn btn-outline-primary mx-3 my-3'}
                                                    key={i}
